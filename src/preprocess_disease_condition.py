...
def alter_disease_condition(annotated_human_miRNA: sc.AnnData):
    ...
    annotated_human_miRNA.obs.loc[annotated_human_miRNA.obs["Disease_Condition"] == "control", "Disease_Condition"] = "Control"
    annotated_human_miRNA.obs.loc[annotated_human_miRNA.obs["Disease_Condition"] == "C", "Disease_Condition"] = "Control"
    annotated_human_miRNA.obs.loc[annotated_human_miRNA.obs["Disease_Condition"].str.contains("Control"), "Disease_Condition"] = "Control"
